...
PropertyId_Conversation_TaskDialogAppId = _speech_py_impl.PropertyId_Conversation_TaskDialogAppId
...
class DialogServiceConfig(SpeechConfig):
    ...
    if _newclass:
        from_task_dialog_app_id = staticmethod(_speech_py_impl.DialogServiceConfig_from_task_dialog_app_id)
    else:
        from_task_dialog_app_id = _speech_py_impl.DialogServiceConfig_from_task_dialog_app_id

    def set_secret_key(self, secretKey )  :
        return _speech_py_impl.DialogServiceConfig_set_secret_key(self, secretKey)

    def get_secret_key(self)  :
        return _speech_py_impl.DialogServiceConfig_get_secret_key(self)

    def set_task_dialog_app_id(self, appId )  :
        return _speech_py_impl.DialogServiceConfig_set_task_dialog_app_id(self, appId)

    def get_task_dialog_app_id(self)  :
        return _speech_py_impl.DialogServiceConfig_get_task_dialog_app_id(self)
...
def DialogServiceConfig_from_task_dialog_app_id(appId , subscription , region )  :
    return _speech_py_impl.DialogServiceConfig_from_task_dialog_app_id(appId, subscription, region)
DialogServiceConfig_from_task_dialog_app_id = _speech_py_impl.DialogServiceConfig_from_task_dialog_app_id
...
class Activity(_object):
    ...
    __repr__ = _swig_repr
    if _newclass:
        from_serialized_activity = staticmethod(_speech_py_impl.Activity_from_serialized_activity)
    else:
        from_serialized_activity = _speech_py_impl.Activity_from_serialized_activity

    def serialize(self)  :
        return _speech_py_impl.Activity_serialize(self)
    __swig_destroy__ = _speech_py_impl.delete_Activity
    __del__ = lambda self: None
Activity_swigregister = _speech_py_impl.Activity_swigregister
...
def Activity_from_serialized_activity(activity )  :
    return _speech_py_impl.Activity_from_serialized_activity(activity)
Activity_from_serialized_activity = _speech_py_impl.Activity_from_serialized_activity
